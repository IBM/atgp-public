...
from functions.styblinski_tang import source, target, feature_space_range
...
np.savez('parallel_test_dataset_styblinski_2_source_1000_target_sampler', source_data, target_data, test_data, shifts)
